...
-- Template 데이터 삽입
INSERT INTO template (template_type, template_check_required_status, template_training_type, template_title, template_sub, template_detail, template_url_name, template_task_round, template_procedure, reg_date)
VALUES
